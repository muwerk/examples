...
A simple example demonstrating muwerk's scheduler, munet interface to WLAN, NTP, OTA and MQTT, with an OLED display
that shows values of sensors via MQTT e.g. from Home-Assistant.
